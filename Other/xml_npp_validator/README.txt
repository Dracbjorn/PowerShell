...
xml schemas for unix xml documents are stored:

Y:\CDT_Resources\unix_xml_schemas\assest_exam.xsd
Y:\CDT_Resources\unix_xml_schemas\asset_question_pool.xsd
Y:\CDT_Resources\unix_xml_schemas\asset_case_study.xsd

You must add the following to your <casestudy> tag:

<caseStudy
	xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
	xsi:noNamespaceSchemaLocation="Y:\CDT_Resources\unix_xml_schemas\asset_case_study.xsd">